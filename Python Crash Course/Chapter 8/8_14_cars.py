# 8-14. Cars: Write a function that stores information about a
# car in a dictionary. The function should always receive a
...
# pairs, such as a color or an optional feature. Your function
# should work for a call like this one: car =
